...
wp.blocks.registerBlockType("ourplugin/are-you-paying-attention", {
    ...
    attributes: {
        ...
        answers: {type: "array", default: [""], correctAnswer: {type: "number", default: undefined}}
...
function EditComponent (props){
    ...
    function markAsCorrect (indexCorrect) {
        props.setAttributes({correctAnswer: indexCorrect})
    }
