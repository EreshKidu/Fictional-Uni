...
//Build query for all found programs/events to find all professors
//Its a second query and then we concat it with query above
...
// Remove duplicates and then remove numeration
