...
class MyNotes {
  ...
  deleteNote(e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      //jQuery allows not to use 'data' word in object's data - for example, 'id' below
...
class Search {
  ...
  constructor() {
    this.addSearchHTML(); //Search for HTML classes and IDs
  ...
  openOverlay() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").addClass("body-no-scroll"); //Clear Search

    this.searchField.val(''); //Make search active
  ...
  getResults() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(uniData.root_url + "/wp-json/uni/v1/search?term=" + this.searchField.val(), results => {
      this.resultsDiv.html(`
            <div class="row">
                <div class="one-third">
